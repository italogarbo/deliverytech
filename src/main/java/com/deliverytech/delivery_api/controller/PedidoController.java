...
public class PedidoController {
    ...
    @SuppressWarnings("unused") // colocado esse comando para evitar aviso de método não usado
    @Transactional 
    @PostMapping("/{pedidoId}/itens")
    public ResponseEntity<PedidoResponse> adicionarItem(@PathVariable Long pedidoId,
                                                       @RequestParam Long produtoId,
                                                       @RequestParam Integer quantidade) {
        Produto produto = produtoService.buscarPorId(produtoId) // Nesse linha estava dando alerta de aviso.
